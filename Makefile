...
all: PostVault PV_MakeUser

PostVault: *.c Common/*.c
	$(CC) $(CFLAGS) -DPV_LOCAL -o PostVault *.c Common/*.c -lsodium -lcap

PV_AddUser: Utils/AddUser.c Common/AEM_KDF.c Common/GetKey.c Common/ToggleEcho.c
	$(CC) $(CFLAGS) -o PV_AddUser Utils/AddUser.c Common/AEM_KDF.c Common/GetKey.c Common/ToggleEcho.c -lsodium

PV_MakeUser: Utils/MakeUser.c Common/AEM_KDF.c Common/GetKey.c Common/ToggleEcho.c
	$(CC) $(CFLAGS) -o PV_MakeUser Utils/MakeUser.c Common/AEM_KDF.c Common/GetKey.c Common/ToggleEcho.c -lsodium
